...
public class ExamenArrayList {
    ...
    public static void main(String[] args) {
        ...
        int n, cont=0,c=0;
        double distancia=100,suma=0,  a=100;
        ...
        for(int x=0; x<n ; x++){
            ...
            System.out.println("Velocidad: "+ velocidad.get(x)+" m/s");
            System.out.println("Tiempo: "+tiempo.get(x)+" segundos");
            System.out.println("-----------------------------------------");
        ...
        System.out.println("El estudiante mas rapido es "+ nombre.get(c)+" con un tiempo de: "+ tiempo.get(c)+" segundo");
